...
Các hướng dẫn dưới đây phản ánh stable `v0.13.0`. Command trên máy luôn kiểm theo bản đang cài bằng `alp --help`.
...
Nguồn kiểm chứng chính: [`src/cli/`](https://github.com/phucanh08/alp-code/tree/v0.13.0/src/cli), [`src/agents/loader/`](https://github.com/phucanh08/alp-code/tree/v0.13.0/src/agents/loader) và [`src/policy/`](https://github.com/phucanh08/alp-code/tree/v0.13.0/src/policy).
...
**Nguyên nhân:** Vai cha đến từ execution đang chạy chứ không từ biến môi trường, nên `alp delegate` gõ từ terminal trần không còn cha để đứng dưới.
