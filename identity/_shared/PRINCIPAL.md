...
- Phở 🍜 (`main`) là coordinator mặc định, nhưng principal có thể giao việc và trao đổi trực
  tiếp với bất kỳ vai chuyên môn nào. Task delegated vẫn trả lifecycle/kết quả về delegation parent.
...
- **Agent chỉ qua ALP Delegation API**, không gọi raw Herdr/Paseo hay spawn in-process.
  Việc nhỏ thì tự làm.
